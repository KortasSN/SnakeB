...
public class DrawSnakeGamePanel extends JPanel {
    ...
    static public void displayGameOptions(Graphics g) {
        g.clearRect(100,100,350,350);


        g.drawString("OPTIONS", 150, 150);
        g.drawString("1. Change Window Size", 150, 200);
        g.drawString("2. Change Game Speed", 150, 250);
        g.drawString("3. Change Color", 150, 300);
...
//        	case 4: break;          //playgame
    ...
    private void displayGameOver(Graphics g) {
        ...
        g.drawString("Press o to enter options",150,450);
    }
    ...
    private void displayInstructions(Graphics g) {
        ...
        g.drawString("Press o to enter options",100,450);
    }
}
